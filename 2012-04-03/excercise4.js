...
// Disegno un tavolo e lo traslo due volte davanti fontana più grande

var piano = CUBOID([1,1,0.2]);
var superficie = (T([0,1,2])([0,0,0.7])(piano));
var gamba = CUBOID([0.1,0.1,0.7]);
var gamba1 = (T([0])([0.9])(gamba));
var gamba2 = (T([1])([0.9])(gamba));
var gamba3 = (T([0,1])([0.9,0.9])(gamba));

var gambe = STRUCT([gamba,gamba1,gamba2,gamba3]);

var tavolo = STRUCT([gambe,superficie]);

var tavoloTraslato1 = T([0,1,2])([12,12,1.5])(tavolo);
var tavoloTraslato2 = T([0,1,2])([15,12,1.5])(tavolo);

var tavoli = COLOR([1,0,0])(STRUCT([tavoloTraslato1,tavoloTraslato2]));

var pavillon = STRUCT([pavimento, acqua,gradini, pareti, divisori, pilastri, vetri,panca, tetti,tavoli]);
